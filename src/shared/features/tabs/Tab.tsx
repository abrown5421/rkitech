...
import { markAsRead } from '../../../client/features/notifications/notificationSlice';
  ...
  return (
    <Button
      ...
      TwClassName={clsx(
        ...
        active
          ? 'border-primary text-amber-500'
          : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
      )}
    >
      {label}
      {notificationObj.length > 0 && label === 'Friend Requests' && (
        <Container TwClassName="absolute top-0 right-0 bg-error text-gray-50 text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow ml-2">
